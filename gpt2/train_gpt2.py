...
def train():
    ...
    while True:
        ...
        if master_process and  iter_num > 0 and iter_num % ckpt_interval == 0 or iter_num  in [round(max_iters*0.001),round(max_iters*0.025), round(max_iters*0.05), round(max_iters*0.075), round(max_iters*0.1)]:
